...
@Component({
  selector: 'app-tempsense-sigbfox',
  templateUrl: './tempsense-sigbfox.component.html',
  styleUrls: ['./tempsense-sigbfox.component.css']
})
export class TempsenseSigbfoxComponent implements OnInit {
