...
@Component({
  selector: 'app-corriente-alterna',
  templateUrl: './corriente-alterna.component.html',
  styleUrls: ['./corriente-alterna.component.css']
})
export class CorrienteAlternaComponent implements OnInit {
