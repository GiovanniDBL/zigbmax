...
@Component({
  selector: 'app-dropsafe-sigfox',
  templateUrl: './dropsafe-sigfox.component.html',
  styleUrls: ['./dropsafe-sigfox.component.css']
})
export class DropsafeSigfoxComponent implements OnInit {
