...
@Component({
  selector: 'app-puentes-viales',
  templateUrl: './puentes-viales.component.html',
  styleUrls: ['./puentes-viales.component.css']
})
export class PuentesVialesComponent implements OnInit {
